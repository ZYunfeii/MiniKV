...
class KVServer final {
 public:
  ...
  typedef WithCallbackMethod_SetKV<WithCallbackMethod_GetKV<Service > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_SetKV<WithStreamedUnaryMethod_GetKV<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_SetKV<WithStreamedUnaryMethod_GetKV<Service > > StreamedService;
};
